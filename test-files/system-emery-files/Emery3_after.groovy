Emery.log.error "Start of the script Emery3"
def rowCount = 0
...
row1002.api = "join"
try{
    String[] array = ["apple","mango", "  ", "(&%^)", "banana", "grapes", "orange"];
...
try{
	row1104.results = Emery.util.getUserId("invalid_user_id")
	}
catch(Exception e){
