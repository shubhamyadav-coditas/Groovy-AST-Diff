Emery.log.error "Start script Emery2"
...
F.gr5.rows << row31
Emery.log.error "isMDOS: {}", row30.results
...
F.gr5.rows << row33
Emery.log.error "addHours: {}", row33.results
...
F.gr5.rows << row34
Emery.log.error "addMilliseconds: {}", row34.results

//addMinutes
def row35 = F.gr5.newRow()
row35.results = "35"
row35.api = "addMinutes"
try{
	Date date2 = new Date(2020,7,22)
	int day2 = 30
...
Emery.log.error "isSameDate-VALID: {}", row39.results
...
row41.api = "isSameDateTime-VALID"
try{
...
row44.api = "isTodayBetween-STRING"
try{
	String fromDateString = "05/15/2020 03:30:01"
	String untilDateString = "05/15/2020 03:30:01"
...
try{
	...
	cal.set(2020, 7, 15, 9, 30, 30, 10, 20)
	Date baseDate = cal.getTime()
	String format2 = "dd-MMM-yyyy HH:mm:ss.SSS"
...
/**************************************** Row no starting from 61 ********************************************/

//getMdosDisplayValuesClob - Passing single stored value
def row61 = F.gr5.newRow()

row61.api = "getMdosDisplayValuesClob_SingleStoredValue Enhanced"
try{
	row61.results = Emery.mdos.getMdosDisplayValuesClob('100000',',','',10010)
	}
catch(Exception e){
...
row62.api = "getMdosDisplayValuesClob_MultipleStoredValue Enhanced"
...
row63.api = "getMdosDisplayValuesClob_StringDelimiter Enhanced"
...
F.gr5.rows << row63
Emery.log.error "getMdosDisplayValuesClob_StringDelimiter Enhanced: {}", row63.results
...
row64.api = "getMdosDisplayValuesClob_DisplayValueDelimiter"
try{
...
F.gr5.rows << row64
Emery.log.error "getMdosDisplayValuesClob_DisplayValueDelimiter: {}", row64.results
...
try{
	row65.results = Emery.mdos.getMdosDisplayValuesClob('100000,100001','','###',10010)
	}
catch(Exception e){
