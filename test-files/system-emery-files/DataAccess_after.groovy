...
Emery.log.error "Start Data Access API endpoints"
//Step 1 - Clear previous records in DO and then count
def row1801 = F.gr5.newRow()
row1801.api = "Step 1 - Clear previous records in DO and then count afterwards"
...
try{
    ...
    int count3 = Emery.dataobject.count(countQuery)
...
Emery.log.error "Data Access API endpoints completed successfully"
